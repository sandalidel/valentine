...
function navigate(screenId) {
    ...
    document.body.classList.remove('flower-bg', 'music-bg');
    ...
    if (target) {
        ...
        if (screenId === 'music') document.body.classList.add('music-bg');
...
function initPlayer(videoId) {
    ...
    player = new YT.Player('player', {
        ...
        playerVars: { 
            'autoplay': 1, 
            'controls': 1, 
            // Change 'http://localhost' to window.location.origin
